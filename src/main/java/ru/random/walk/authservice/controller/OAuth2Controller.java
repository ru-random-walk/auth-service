...
import ru.random.walk.authservice.service.oauth2.providers.factory.CustomEmailOtpTokenRequestFactory;
...
public class OAuth2Controller {
    ...
    private final static List<String> SUPPORTED_GRANT_TYPES = List.of(
            ...
            CustomEmailOtpTokenRequestFactory.CUSTOM_EMAIL_OTP_GRANT_TYPE
    );
